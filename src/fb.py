...
oauth_config = {
    "web": {
        ...
        # Using legacy configuration for Google client for convenience. All requests here 308 to the main URL anyways
        "redirect_uris": ["http://localhost:5000/api/oauth2callback"] if os.getenv("FLASK_ENV") == 'development' else [
            "https://roboregistry.vercel.app/api/oauth2callback"],
        "javascript_origins": ["http://localhost:5000"] if os.getenv("FLASK_ENV") == 'development' else [
